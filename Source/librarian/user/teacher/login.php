...
<head>
    ...
    <style>
        .login{
            background-image: url(inc/images/bg1.png);
            margin-bottom: 50px;
            padding: 60px;
...
<body>
				...
				<div class="login-footer text-center">
                 ...
                 <?php 
                    if (isset($_POST["login"])) {
                        $count=0;
                        $res= mysqli_query($link, "select * from t_registration where username='$_POST[username]' && password= '$_POST[password]'");
	...
	<div class="footer text-center">
        <p>&copy; All rights reserved by SBIT-3G</p>
    </div>
